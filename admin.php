...
document.getElementById("searchPriorityForm").addEventListener("submit", function(event) {
	...
	<form action="" method="POST">
        <div class="form-group">
            <input type="search" class='form-control' style="width:50%;float:left" name="searchPriority" placeholder="Search Priority Complaints">
            <button class="btn btn-primary" style="margin-top:20px" name="searchPriorityBtn" type="submit">Search</button>
        </div>
    </form>
	<div id="PendingResults"></div>
			...
			<form action="" method="POST">
        <div class="form-group">
            <input type="search" class='form-control' style="width:50%;float:left" name="searchInProgress" placeholder="Search InProgress Complaints">
	...
	<div id="inProgressResults"></div>
			...
			<form action="" method="POST">
        <div class="form-group">
            <input type="search" class='form-control' style="width:50%;float:left" name="searchCompleted" placeholder="Search Completed Complaints">
	...
	<div id="CompletedResults"></div>
		...
		<script>
    // Function to handle search for in progress complaints
    function searchInProgress() {
        var searchInProgressValue = document.getElementById("searchInProgress").value;

        // AJAX request
        var xhr = new XMLHttpRequest();
        xhr.open("POST", "searchInProgress.php", true);
        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4 && xhr.status === 200) {
                document.getElementById("inProgressResults").innerHTML = xhr.responseText;
            }
        };
        xhr.send("searchInProgress=" + searchInProgressValue);
    }

    // Function to handle search for completed complaints
